...
public class LockerService extends Service {
   ...
   public int onStartCommand(Intent intent, int flags, int startId) {
	...
	public void onCreate() {
		...
		mStatus = Settings.System.getInt(getBaseContext().getContentResolver(),"Capsteal", 0);
		...
		if (mStatus == 1) {
			...
			mKeyguardLock = ((KeyguardManager) getSystemService(Context.KEYGUARD_SERVICE)).newKeyguardLock("Capsteal");
