...
public class PickerApp extends ActionBarActivity {
	...
	@Override
	protected void onCreate(Bundle RainOfpick) {
		
		super.onCreate(RainOfpick);
		...
		SharedPreferences sp = getSharedPreferences("pickPicker", Context.MODE_PRIVATE);
		...
		if (DEBUG) {
			...
			if (CurGet == null | CurGet == "") {
				...
				Log.e(TAG_NAME, "This is First View of pickPicker");
