...
import com.capstealstable.LockerService;
import com.capstealstable.PinActivity;
	...
	public ShortcutView(final Context context, AttributeSet attrs) {
		...
		for (int i = 0; i < CAPACITY; i++) {
			...
			if (s == null | s == "") {
				...
				Settings.System.putString(context.getContentResolver(), "PiSC"+b, "com.capstealstable");
			}
			sv = s;
